...
__all__ = ["read_coefficients", "write_coefficients", "write_coefficients_custom", "quantize_at_quality", "quantize_at_quality_custom", "pixels_for_channel", "reconstruct_full_image"]  # pylint: disable=undefined-all-variable
...
def reconstruct_full_image(y_coefficients: Tensor, quantization: Tensor, cbcr_coefficients: Optional[Tensor] = None, crop: Optional[Tensor] = None, raw: bool = False) -> Tensor:
    r"""
    ...
    raw : bool
        Do not use final conversion to RGB
